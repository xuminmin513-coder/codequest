...
const GAMIFICATION = {
  ...
  BADGES: [
    ...
    { id: 'all_done', name: 'Python Master', nameCn: 'Python大师', icon: '🏆', desc: '完成所有课程', descCn: 'Complete all courses', condition: (stats) => stats.completedLessons >= 40 },
  ...
  getChapterTitle(chapter) {
    ...
    return lang === 'zh' ? chapter.title : chapter.titleEn;
  },

  // Get lesson title
  getLessonTitle(lesson) {
    const lang = localStorage.getItem('lang') || 'zh';
    return lang === 'zh' ? lesson.title : lesson.titleEn;
  },
